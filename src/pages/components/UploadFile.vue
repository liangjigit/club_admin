  ...
  <div class="clearfix" style="position:relative">
    ...
    >
      ...
      <a-button
        ...
        type="danger"
        size="small"
        style="position: absolute;width: 50px;right: 0;top: 0;"
      >
        移除
      </a-button>
    </a-upload>
      ...
      switch (info.file.status) {
        ...
        case "done":
          ...
          if (response.code == 200) {
            ...
            this.$emit("uploadPic", { imageUrl: response.data });
        ...
        case "error":
          ...
          // eslint-disable-next-line no-case-declarations
          const {
            response: { status, errMsg: statusText }
          } = info.file;
          // 错误消息提示
          notification.error({
