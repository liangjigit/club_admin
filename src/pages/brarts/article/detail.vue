  ...
  <div style="background-color:#fff;padding:15px">
    <a-spin :spinning="loading" :delay="500">
      <a-descriptions
        ...
        layout="vertical"
        :column="{ xxl: 6, xl: 5, lg: 3, md: 2, sm: 2, xs: 1 }"
        bordered
        size="small"
      >
        <a-descriptions-item label="封面图">
          <img :src="articleDetail.img" style="width:167.5px;height:94px" />
        </a-descriptions-item>
        ...
        <a-descriptions-item label="分享标题">
          ...
          <span v-if="!articleDetail.shareTitle">-</span>
        </a-descriptions-item>
...
export default {
  ...
  methods: {
    ...
    init() {
      if (this.$route.name != "brartsArticleDetail") {
        return;
      }
      this.getData();
    },
