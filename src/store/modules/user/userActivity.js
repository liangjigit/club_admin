...
const actions = {
  async saveUserActivityConfig({ commit }, payload) {
    const response = (
      await request({
  ...
  async saveUserRegConfig({ commit }, payload) {
    const response = (
      await request({
  ...
  async saveUserInfoConfig({ commit }, payload) {
    const response = (
      await request({
  ...
  async saveUserInviteConfig({ commit }, payload) {
    const response = (
      await request({
  ...
  async getUserActivityConfig({ commit }) {
    const response = (
      await request({
    ...
    if (response.code == 200) {
      ...
      commit("GETUSERACTIVITYCONFIG", { userActivityConfigs });
    }
    return response;
  },
  async getUserInviteConfig({ commit }) {
    const response = (
      await request({
    ...
    if (response.code == 200) {
      ...
      commit("GETUSERINVITECONFIG", { userInviteConfig });
    }
    return response;
  },
  async getUserRegConfig({ commit }) {
    const response = (
      await request({
    ...
    if (response.code == 200) {
      ...
      commit("GETUSERREGCONFIG", { userRegConfig });
    }
    return response;
  },
  async getUserInfoConfig({ commit }) {
    const response = (
      await request({
    ...
    if (response.code == 200) {
      ...
      commit("GETUSERINFOCONFIG", { userInfoConfig });
    }
    return response;
  },
  async getCouponTemplates({ commit }, payload) {
    const response = (
      await request({
    ...
    if (response.code == 200) {
      ...
      commit("GETCOUPONTEMPLATES", { couponTemplates });
    }
    return response;
  },
  async getUserActivitys({ commit }) {
    const response = (
      await request({
    ...
    if (response.code == 200) {
      ...
      commit("GETUSERACTIVITYS", { userActivitys });
    }
    return response;
  },
  ...
  async getUserFileds({ commit }, payload) {
    const { type } = payload;
    const response = (
      await request({
    ...
    if (response.code == 200) {
      ...
      commit("GETUSERFIELDS", { userFields });
    }
    return response;
  }
};
